/**
 * macOS Service Entry Point
 *
 * LaunchDaemon entry point for ScreenControl Service.
...
// Check if running as root (required for LaunchDaemon)
...
int main(int argc, char* argv[])
{
    ...
    for (int i = 1; i < argc; i++)
    {
        ...
        {
            std::cout << "ScreenControl Service for macOS\n"
    ...
    Logger::info("ScreenControl Service starting [macOS]");
